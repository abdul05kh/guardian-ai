...
const NAV_ITEMS = [
  ...
  { href: '/threat-network', icon: '🕸️', label: 'Threat Network', badge: { count: 'AI', type: 'warning' } },
  ...
  { section: 'ENTERPRISE' },
  { href: '/forecast', icon: '🌍', label: 'Threat Forecast', badge: { count: 'βeta', type: 'warning' } },
  { href: '/policies', icon: '⚡', label: 'Auto-Policies', badge: { count: 'AI', type: 'purple' } },
  { section: 'COMPLIANCE' },
